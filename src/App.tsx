...
const PinwheelLogo = () => (
  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M12 12C12 8.68629 9.31371 6 6 6C2.68629 6 0 8.68629 0 12C0 12 0 12 0 12H12Z"
      fill="#4285F4"
      transform="translate(12, 0)"
    />
    <path
      d="M12 12C15.3137 12 18 9.31371 18 6C18 2.68629 15.3137 0 12 0C12 0 12 0 12 0V12Z"
      fill="#EA4335"
      transform="translate(0, 0)"
    />
    <path
      d="M12 12C12 15.3137 14.6863 18 18 18C21.3137 18 24 15.3137 24 12C24 12 24 12 24 12H12Z"
      fill="#FBBC05"
      transform="translate(-12, 0)"
    />
    <path
      d="M12 12C8.68629 12 6 14.6863 6 18C6 21.3137 8.68629 24 12 24C12 24 12 24 12 24V12Z"
      fill="#34A853"
...
const Header = ({
  ...
  >
    <div style={{ display: "flex", alignItems: "center", flexShrink: 0 }}>
      ...
      <h1 style={{ fontSize: "18px", fontWeight: 400, color: "var(--text-primary)", letterSpacing: "-0.02em" }}>
        Photika
      </h1>
    </div>
...
function AppContent() {
  ...
  const handleNavigate = (nextView: AppView) => {
    ...
    if (nextView === "photos") setSelectedDateKey(null);
    if (nextView !== "jobDetails") setSelectedJobId(null);
    if (nextView !== "albums") setSelectedAlbumSectionId(null);

    // clear selection when leaving metadata
    if (nextView !== "metadata") setSelectedPhotoId(null);
  };
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        <Sidebar isOpen={isSidebarOpen} view={view} onNavigate={handleNavigate} />
          ...
          <div style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0 }}>
            {view === "photos" || view === "albums" ? (
              ...
              (() => {
                ...
                if (!job) {
                  return <div style={{ padding: 24, color: "var(--text-muted)" }}>Job not found.</div>;
                }
                return (
                  <JobDetailsPage
                    job={job}
